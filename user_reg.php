                     ...
                     <br>
                            <div class="box2">
                                   ...
                                   <form  action="" method="post">
                                      <div class="login">
                                          <input style="margin:auto 25px;"type="text" name="first_name" placeholder="First Name" required=""><br><br>
                                   ...
                                   <p style="color: white; padding-left: 90px;">
                                         ...
                                         Already have an account?<a style="color:white;" href="user_login.html">Login</a>
                                   </p>
                            </div>
                     </div>
              </section>
